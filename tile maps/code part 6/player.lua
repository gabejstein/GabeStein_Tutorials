...
function Player:OnCollision(other)
    --It's worth noting that the game object may be inactive, but the collider is still there.
    --I'll talk more about that in the next video, hopefully.
    if other.isActive then
